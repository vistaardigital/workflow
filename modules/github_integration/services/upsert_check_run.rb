...
module GithubIntegration
  ...
  #
  # Returns the `id` of the upserted `GithubCheckRun`.
  #
  ...
  class UpsertCheckRun < ::BaseServices::BaseCallable
    ...
    def perform(params)
      GithubCheckRun.upsert(extract_params(params), unique_by: :github_id)
                    .fetch(:id)
    end
    ...
    def pull_request_id(params)
      GithubIntegration::UpsertPullRequest.new.call(params)
    end
  end
end
